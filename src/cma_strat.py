...
class cma_hyperparams:
    ...
    cma_sigma0=0.1
    n_middle_layers=2 # it is actually the number of mid-layer to mid-layer weight-sets
    n_params_middle_layers=1
...
class cma_strat(optimization_strat):
    ...
    def __init__(self, n_in, n_out, seed):
        ...
        x0 = self.random_state.normal(cma_hyperparams.mean_normal_initialization, cma_hyperparams.std_normal_initialization, cma_nn(n_in, n_out)._get_total_dim())
